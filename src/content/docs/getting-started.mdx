...
|---|---|---|
| `401` | The key is missing, misspelled or gone | Check the `Authorization: Bearer ...` header |
| `402` | You have spent that model's token quota | Switch models or wait for your next period to start |
| `403` | Your plan does not reach that model or that endpoint | `glm5.3` needs the premium tier |
