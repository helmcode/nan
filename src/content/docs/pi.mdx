...
This is the config for the 8 LLM models NaN serves: `deepseek-v4-flash`, `glm5.3-flash`, `qwen3.8-flash`, `mimo-v2.5`, `mimo-v2.6-flash`, `gemma4`, `qwen3.6` and `glm5.3`. It is the same set the [NaN CLI](/docs/nan-cli) writes, and the same one the [OpenCode](/docs/opencode) page publishes. It is the same set the [NaN CLI](/docs/nan-cli) writes, and the same one the [OpenCode](/docs/opencode) page publishes.
