...
- **Las ventanas son las de verdad.** Están medidas contra el proxy, y son las mismas cifras que lleva el bloque de [VS Code](/es/docs/vscode) y que las fichas de [Modelos](/es/docs/models) publican redondeadas. Si las subes a mano, OpenCode llenará la conversación hasta un punto en el que el modelo empieza a rechazar peticiones.
