...
<ModelCard
  ...
  specs={[
    ...
    { label: 'Modalidades de entrada', value: 'texto' },
...
<ModelCard
  ...
  specs={[
    ...
    { label: 'Modalidades de salida', value: 'texto' },
    { label: 'Cuota mensual', value: '3B tokens / miembro' },
  ]}
  items={[
    'Tool calling',
    'Modo razonamiento',
...
<ModelCard
  ...
  rightLabel="capacidades"
  description="Modelo MoE de 320B parámetros (18B activos), multimodal de forma nativa, con tool calling y razonamiento. Contexto de 1M tokens. Cuota de 2B tokens al mes por miembro. Licencia MIT."
  specs={[
...
<ModelCard
  ...
  leftLabel="generación de texto y chat"
  rightLabel="capacidades"
  description="La generación anterior. MoE de 35B parámetros, multimodal, con tool calling y razonamiento. Sigue respondiendo para que las configuraciones que lo nombran no se rompan, pero hoy se empieza por deepseek-v4-flash."
  specs={[
...
<ModelCard
  ...
  leftLabel="generación de imágenes"
  rightLabel="capacidades"
  description="Modelo de imagen Qwen para texto a imagen con buena adherencia al prompt y texto legible dentro de la imagen. Compatible con la API de Images de OpenAI (/v1/images/generations). Requiere membresía del tier de inferencia."
  specs={[
    { label: 'Tipo', value: 'Difusión (Qwen-Image)' },
    { label: 'Modalidades', value: 'texto→imagen' },
    { label: 'Resolución', value: '512–1280 px (múltiplos de 16)' },
    { label: 'Imágenes / petición', value: '1–4 (n)' },
    { label: 'Cuota mensual', value: '100 peticiones / miembro (compartidas con flux-2-klein)' },
  ]}
  items={[
    'Texto a imagen (<code>/v1/images/generations</code>)',
    'Salida como URL temporal (R2, ~60 min) o base64',
    'Reproducibilidad vía <code>seed</code> (0–2147483647)',
  ]}
/>
